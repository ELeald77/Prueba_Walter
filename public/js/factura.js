        ...
        productosFactura.forEach((item, index) => {
            ...
            tbody.append(`
                <tr>
                    ...
                    <td>${item.cantidad}</td>
                    <td>${item.unidad}</td>
                    <td class="text-end">Q${item.precio.toLocaleString('es-CO')}</td>
                    <td class="text-end">Q${item.subtotal.toLocaleString('es-CO')}</td>
        ...
        pedidosGuardados.forEach((pedido, index) => {
            ...
            tbody.append(`
                <tr>
                    ...
                    <td>Q${pedido.total.toLocaleString('es-CO')}</td>
                    <td>
